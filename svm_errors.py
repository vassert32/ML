...
Original file is located at
    https://colab.research.google.com/drive/1wF3vshaZvg9nwURrcG6L6ioKehF3Op4c
"""
...
# обучающая выборка с тремя признаками (третий - константа +1) - тут присутствуют 2 выброса, 2 первых вектора
...
plt.scatter(v[:, 0], v[:, 1], s=70, edgecolor=None, linewidths=0, marker='s')   # отрисовка опорных
